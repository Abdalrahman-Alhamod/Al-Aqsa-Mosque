...
public:
     ...
     */
    void drawDome(const Point& position, const float size, const Color& color, int sectorCnt = 36, bool inside = false, bool lines = true, bool smooth = true,bool crescent = true);
